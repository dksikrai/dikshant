          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-3">
                <a
                  href={siteConfig.links.linkedin} target="_blank" rel="noopener noreferrer"
                ...
                <a
                  href={siteConfig.links.instagram} target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href={`mailto:${siteConfig.email}`} className="flex items-start gap-2.5 text-sm text-muted-foreground hover:text-primary smooth-transition group">
                    <Mail className="w-4 h-4 mt-0.5 group-hover:text-primary smooth-transition shrink-0" />
                    {siteConfig.email}
                  </a>
                </li>
                <li>
                  <a href={`tel:${siteConfig.phone}`} className="flex items-center gap-2.5 text-sm text-muted-foreground hover:text-primary smooth-transition group">
                    <Phone className="w-4 h-4 group-hover:text-primary smooth-transition shrink-0" />
                    {siteConfig.phone}
                  </a>
                </li>
                <li>
                  <a href={siteConfig.whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-sm text-muted-foreground hover:text-primary smooth-transition group">
